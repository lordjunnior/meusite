  ...
  return (
    <div className="min-h-screen text-stone-100 font-sans selection:bg-amber-300/50 relative overflow-hidden" style={{ background: '#050606' }}>
      ...
      <div className="relative w-full h-[92vh] min-h-[640px] overflow-hidden">
        <img src={heroImg} alt="Cofre bancario marmore com banknotes brasileiras sob luz dramatica" className="absolute inset-0 w-full h-full object-cover" width={1920} height={1080} loading="lazy" decoding="async" />
