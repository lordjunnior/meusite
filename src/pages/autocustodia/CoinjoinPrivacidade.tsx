  ...
  return (
    <section className="relative h-[88vh] min-h-[640px] w-full overflow-hidden" style={sectionBg.privacyWash}>
      <motion.div className="absolute inset-0" style={{ y: yBg }}>
        <img src={heroImg} alt="" className="w-full h-full object-cover scale-110" style={{ filter: 'saturate(1.02) contrast(1.02)' }} loading="eager" fetchPriority="high" decoding="async" />
