    ...
    <div ref={containerRef} className="min-h-screen bg-[#050808] text-zinc-100">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Rede Neural analisando mercados Bitcoin na Polymarket" className="w-full h-full object-cover" loading="eager" fetchPriority="high" decoding="async" />
