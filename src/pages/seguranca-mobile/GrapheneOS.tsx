...
import heroAsset from '@/assets/seguranca-mobile/grapheneos-hero.webp';
import logoAsset from '@/assets/seguranca-mobile/grapheneos-logo.svg';
import bancadaAsset from '@/assets/seguranca-mobile/grapheneos-bancada.webp';
import arquiteturaAsset from '@/assets/seguranca-mobile/grapheneos-isolamento-operacional.webp';
import pixelsAsset from '@/assets/seguranca-mobile/grapheneos-pixels-compativeis.webp';
import instalacaoAsset from '@/assets/seguranca-mobile/grapheneos-instalacao.webp';
import redeAsset from '@/assets/seguranca-mobile/grapheneos-rede.webp';
import diagnosticoAsset from '@/assets/seguranca-mobile/grapheneos-diagnostico.webp';
import appsGovernanceBackground from '@/assets/seguranca-mobile/grapheneos-apps-governance-background.webp';
import sandboxedPlayImage from '@/assets/seguranca-mobile/grapheneos-sandboxed-play.webp';
import appPermissionsImage from '@/assets/seguranca-mobile/grapheneos-app-permissions.webp';
import appPilotImage from '@/assets/seguranca-mobile/grapheneos-app-pilot.webp';
import faqBackground from '@/assets/seguranca-mobile/grapheneos-faq-background.webp';
import decisionBackground from '@/assets/seguranca-mobile/grapheneos-decision-background.webp';
import architectureBackground from '@/assets/seguranca-mobile/grapheneos-architecture-background.webp';
import acquisitionBackground from '@/assets/seguranca-mobile/grapheneos-acquisition-background.webp';
import installationBackground from '@/assets/seguranca-mobile/grapheneos-installation-background.webp';
import operationsBackground from '@/assets/seguranca-mobile/grapheneos-operations-background.webp';
import verdictBackground from '@/assets/seguranca-mobile/grapheneos-verdict-background.webp';
import learningPathBackground from '@/assets/seguranca-mobile/grapheneos-learning-path-background.webp';
import communityBackgroundAsset from '@/assets/seguranca-mobile/grapheneos-community-background.webp';
import discordImageAsset from '@/assets/seguranca-mobile/grapheneos-discord-support.webp';
import matrixImageAsset from '@/assets/seguranca-mobile/grapheneos-matrix-support-v3.webp';
import forumImageAsset from '@/assets/seguranca-mobile/grapheneos-forum-support.webp';
import discordLogoAsset from '@/assets/seguranca-mobile/discord-official.svg';
import matrixLogoAsset from '@/assets/seguranca-mobile/matrix-official.svg';
...
function Hero() {
  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden graphene-teal">
      <motion.img style={{ y }} src={heroAsset} alt="Google Pixel em bancada profissional preparado para implantação do GrapheneOS" width={1920} height={1088} fetchPriority="high" decoding="async" className="absolute inset-0 h-[110%] w-full object-cover" />
      ...
      <div className="relative z-10 flex min-h-[88vh] max-w-[1600px] flex-col justify-end px-6 pb-16 pt-36 md:px-12 md:pb-24 lg:px-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7, ease: EASE }} className="mb-7 flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-md bg-background/95 p-2.5 shadow-xl"><img src={logoAsset} alt="Marca oficial do GrapheneOS" width={48} height={48} /></div>
      ...
      <main className="graphene-page min-h-screen">
        ...
        <section id="decisao" className="relative isolate scroll-mt-16 overflow-hidden px-6 py-24 md:px-12 md:py-36 lg:px-20">
          ...
          <div className="relative mx-auto max-w-[1600px]">
            ...
            <motion.div {...reveal(.08)} className="graphene-card border p-7 md:p-10">
              ...
              <Button asChild size="lg" className="graphene-btn-primary graphene-focus mt-8 h-13 px-7 font-bold"><a href="https://grapheneos.org/faq#supported-devices" target="_blank" rel="noopener noreferrer">Validar lista no site oficial <ExternalLink /></a></Button>
            </motion.div>
          </div>
        </section>
        ...
        <section id="instalacao" className="graphene-teal relative isolate scroll-mt-16 overflow-hidden px-6 py-24 md:px-12 md:py-36 lg:px-20">
          ...
          <div className="relative mx-auto max-w-[1400px]">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row"><Button asChild size="lg" className="graphene-btn-dark graphene-focus h-13 px-7 font-bold"><a href="https://grapheneos.org/install/" target="_blank" rel="noopener noreferrer">Abrir página oficial de instalação <ExternalLink /></a></Button><Button asChild size="lg" variant="outline" className="graphene-focus h-13 border-background/30 bg-transparent px-7 font-bold text-background hover:bg-background/10 hover:text-background"><a href="#faq">Revisar objeções técnicas</a></Button></div>
          </div>
        </section>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {COMMUNITY_CHANNELS.map((channel, i) => (
                <motion.article key={channel.title} {...reveal(i * .09)} whileHover={{ y: -8 }} className="graphene-community-card group relative flex min-h-[590px] flex-col overflow-hidden rounded-lg border">
                  <div className="relative h-72 overflow-hidden">
                    <img src={channel.image} alt={`Ambiente visual do ${channel.title}`} loading="lazy" decoding="async" width={1200} height={900} className="h-full w-full object-cover transition-transform duration-1000 ease-out group-hover:scale-[1.08]" />
                    <div className="graphene-community-image-shade absolute inset-0" />
                    <div className="absolute left-6 top-6 flex h-14 min-w-14 items-center justify-center rounded-md border border-background/20 bg-foreground/75 px-3 backdrop-blur-md">
                      <img src={channel.logo} alt={`Marca oficial ${channel.logoAlt}`} loading="lazy" width={38} height={38} className="h-8 max-w-24 object-contain" />
                    </div>
                  ...
                  <div className="relative flex flex-1 flex-col p-7 md:p-8">
                    ...
                    <Button asChild size="lg" className="graphene-btn-dark graphene-focus mt-7 h-14 w-full px-6 font-bold">
                      <a href={channel.href} target="_blank" rel="noopener noreferrer">{channel.action} <ExternalLink className="transition-transform duration-300 group-hover:translate-x-1" /></a>
                    </Button>
                  </div>
                </motion.article>
              ))}
