...
export const SEARCH_ENTRIES: SearchEntry[] = [
  { title: "Biblioteca Técnica da Autonomia Digital", description: "Curadoria própria de recursos técnicos gratuitos, organizada por problema, com fonte primária conferida e status editorial", path: "/biblioteca-tecnica", tags: ["biblioteca técnica", "ferramentas de privacidade", "segurança digital", "código aberto", "curadoria", "osint", "hardening", "documentação oficial"], category: "Biblioteca & Educação" },
  { title: "Cobre: Os 2 Poderes Que Quase Ninguém Conhece", description: "Guia técnico sobre cobre, imunidade, ação antimicrobiana, solo, aplicação prática e limites de segurança", path: "/protocolo-respiratorio/cobre", tags: ["cobre", "imunidade", "antimicrobiano", "ceruloplasmina", "água em vaso de cobre", "cobre no solo", "protocolo respiratório"], category: "Saúde & Biologia" },
  { title: "VPN no Celular, Quando Ajuda e Quando é Teatro", description: "O que uma VPN realmente protege, quando vale a pena e onde vira teatro de segurança", path: "/seguranca-mobile/vpn-no-celular", tags: ["vpn no celular", "vpn protege privacidade", "vpn celular vale a pena", "melhor vpn para celular", "vpn grátis é segura", "quando usar vpn", "vpn wifi público", "política de logs vpn"], category: "Guias Práticos de Hardening" },
  { title: "iPhone, o Celular Mais Seguro do Mundo... Será?", description: "O que a Apple realmente protege, quais dados ainda coleta e quando o iPhone é seguro o suficiente", path: "/seguranca-mobile/iPhone-e-seguro-mesmo", tags: ["iPhone é seguro", "iPhone protege privacidade", "Apple coleta dados", "iPhone rastreamento", "criptografia iPhone", "Lockdown Mode", "iCloud", "segurança mobile"], category: "Curiosidades / Mitos" },
  ...
  { title: "Farmácia Caseira Essencial", description: "Os 15 itens que devem estar em casa, para que servem, dose, validade e custo", path: "/soberania-organica/farmacia-caseira-essencial", tags: ["farmácia caseira", "remédio natural", "mel", "própolis", "carvão ativado", "argila", "óleo de rícino", "kit saúde", "prático"], category: "Saúde" },
  { title: "Tinturas, Xaropes e Preparos", description: "Como fazer tintura, xarope, glicerite e óleo infundido em casa, passo a passo", path: "/soberania-organica/tinturas-xaropes-preparos", tags: ["tintura", "xarope", "glicerite", "óleo infundido", "maceração", "dose por gota", "receita", "fitoterapia"], category: "Saúde" },
  { title: "Protocolos para Gripe e Resfriado", description: "O que fazer hora a hora nos primeiros sinais, febre, tosse, garganta e sinais de alerta", path: "/soberania-organica/protocolos-gripe-resfriado", tags: ["gripe", "resfriado", "febre", "tosse", "dor de garganta", "lavagem nasal", "soro caseiro", "primeiros socorros"], category: "Saúde" },
  { title: "Rotina Diária de Imunidade", description: "Um dia inteiro de hábitos: luz, frio, alimentação, sono e checklist de 7 dias", path: "/soberania-organica/rotina-diaria-imunidade", tags: ["imunidade", "rotina", "sono", "luz solar", "banho frio", "vitamina d", "magnésio", "hábitos", "prevenção"], category: "Saúde" },
  { title: "O que é Custódia Fria", description: "Carteira quente x fria, por que tirar da corretora e quando vale a pena", path: "/autocustodia/o-que-e-custodia-fria", tags: ["custódia fria", "cold storage", "carteira fria", "carteira quente", "hardware wallet", "autocustódia", "iniciante", "not your keys"], category: "Autocustódia" },
  { title: "Tirar Bitcoin da Corretora", description: "Passo a passo do primeiro saque para a carteira física, com teste e taxas", path: "/autocustodia/tirar-da-exchange-para-hardware-wallet", tags: ["saque", "exchange", "corretora", "enviar bitcoin", "endereço", "taxa de rede", "vbyte", "teste", "hardware wallet"], category: "Autocustódia" },
  { title: "Guia da Migração: Como Sair da Corretora", description: "Página pilar: risco de contraparte, checklist de 7 passos e saque de teste", path: "/autocustodia/guia-migracao-corretora", tags: ["migração", "sair da corretora", "risco de contraparte", "not your keys", "saque de teste", "autocustódia", "exchange", "custódia própria"], category: "Autocustódia" },
  { title: "Carteira Quente x Carteira Fria", description: "Hot wallet e cold wallet explicadas, níveis de custódia e o que é seed phrase", path: "/autocustodia/hot-wallet-vs-cold-wallet", tags: ["hot wallet", "cold wallet", "carteira quente", "carteira fria", "seed phrase", "chave privada", "iniciante", "multisig", "passphrase"], category: "Autocustódia" },
  { title: "Primeiro Saque na Hardware Wallet", description: "OpSec completo: lacre, firmware, PIN, teste de restauração e backup em metal", path: "/autocustodia/primeiro-saque-hardware-wallet", tags: ["opsec", "hardware wallet", "configurar", "lacre", "supply chain", "pin", "passphrase", "backup em aço", "primeiro saque"], category: "Autocustódia" },
  { title: "Erros Fatais no Saque de Corretoras", description: "Rede errada, endereço trocado, taxas e transações travadas: como evitar", path: "/autocustodia/erros-fatais-saque-corretora", tags: ["erros", "saque", "rede errada", "taxa de rede", "transação travada", "endereço", "lightning", "on-chain", "utxo", "corretora"], category: "Autocustódia" },
  { title: "Verificar Firmware e Origem", description: "Como saber se a hardware wallet é original e não foi adulterada", path: "/autocustodia/verificar-firmware-origem", tags: ["firmware", "attestation", "lacre", "supply chain", "original", "falsificada", "hash", "pgp", "krux"], category: "Autocustódia" },
  { title: "Foundation Passport Review", description: "Air-gap por QR Code, código aberto e para quem essa carteira serve", path: "/comparativos/foundation-passport-review", tags: ["foundation", "passport", "review", "air-gap", "qr code", "envoy", "hardware wallet", "multisig"], category: "Autocustódia" },
