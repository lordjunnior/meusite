...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Android é mais inseguro que iPhone?", route: "/seguranca-mobile/android-mais-inseguro-que-iphone" },
      { label: "Modo avião desliga o rastreamento?", route: "/seguranca-mobile/modo-aviao-desliga-rastreamento" },
      { label: "Apagar o app encerra o rastreamento?", route: "/seguranca-mobile/apagar-app-rastreamento-continua" },
      { label: "Celular escuta conversas?", route: "/seguranca-mobile/celular-escuta-conversa-anuncio" },
      { label: "IMEI rastreia sem chip?", route: "/seguranca-mobile/imei-rastreia-sem-chip" },
      { label: "O que é IMSI Catcher", route: "/seguranca-mobile/imsi-catcher-como-funciona", section: "Ameaças Específicas" },
      { label: "SIM Swap", route: "/seguranca-mobile/sim-swap-como-funciona" },
      { label: "Stalkerware: apps espiões", route: "/seguranca-mobile/stalkerware-apps-espioes" },
      { label: "Operadora e dados de localização", route: "/seguranca-mobile/operadora-vende-dados-localizacao" },
      { label: "Rastreamento por Bluetooth e Wi-Fi", route: "/seguranca-mobile/bluetooth-wifi-rastreamento" },
